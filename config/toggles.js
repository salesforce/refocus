...
const shortTermToggles = {
  /*
   * test out NOT making a special call to db OR redis to attach the subject--
   * just use the version we already got from redis at the beginning of the
   * upsertOneSample operation
   */
