...
const DEFAULT_BULK_DELETE_SUBJECTS_AUDIT_EVENT_JOB_CONCURRENCY = 1;
...
module.exports = {
  ...
  getBulkDeleteSubjectsJobConcurrency:
    pe.BULK_DELETE_SUBJECTS_AUDIT_EVENT_JOB_CONCURRENCY ||
    DEFAULT_BULK_DELETE_SUBJECTS_AUDIT_EVENT_JOB_CONCURRENCY,
