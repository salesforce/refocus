...
/**
 * tests/cache/models/samples/postWithCreatedBy.js
 */
...
describe(`api: redisStore: POST ${path} with createdBy`, () => {
  let sampleToPost;
  let token;
  ...
  it('when token is provided, createdBy and user object is returned', (done) => {
    api.post(path)
