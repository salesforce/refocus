...
const eventType = {
  ...
  INTRNL_ASP_ADD: 'refocus.internal.realtime.aspect.add',
  INTRNL_ASP_DEL: 'refocus.internal.realtime.aspect.remove',
  INTRNL_ASP_UPD: 'refocus.internal.realtime.aspect.update',
